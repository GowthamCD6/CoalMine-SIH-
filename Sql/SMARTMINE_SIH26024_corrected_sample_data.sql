...
-- DEMO PASSWORD (all sample users): Admin@12345
...
INSERT INTO `permissions` (`id`, `name`, `code`, `description`, `created_at`) VALUES
  ...
  -- IMPORTANT: Page visibility is NOT inferred from generic permissions such as
  -- MINES_READ. Each page gets its own capability so roles do not accidentally
  -- see unrelated operational modules.
  -- ---------------------------------------------------------------------------
  (1001, 'Access System Overview', 'PAGE_ACCESS_DASHBOARD', 'Access platform-wide system overview and health dashboard', NOW()),
  (1002, 'Access Mine Dashboard', 'PAGE_ACCESS_MINE_DASH', 'Access mine operational dashboard', NOW()),
  (1003, 'Access Corporate Dashboard', 'PAGE_ACCESS_CORP_DASH', 'Access organization/subsidiary executive dashboard', NOW()),
  (1004, 'Access Regulatory Dashboard', 'PAGE_ACCESS_REG_DASH', 'Access regulatory oversight dashboard', NOW()),
  (1005, 'Access GIS Command Map', 'PAGE_ACCESS_COMMAND_MAP', 'Access geo-spatial command map', NOW()),
  (1006, 'Access AI Risk Analytics', 'PAGE_ACCESS_ANALYTICS', 'Access AI risk and analytics dashboard', NOW()),
  (1007, 'Access Compliance Hub', 'PAGE_ACCESS_COMPLIANCE', 'Access statutory compliance management', NOW()),
  (1008, 'Access Inspections & Violations', 'PAGE_ACCESS_INSPECTIONS', 'Access inspections, checklists and violations', NOW()),
  (1009, 'Access Incident Management', 'PAGE_ACCESS_INCIDENTS', 'Access incident investigation and corrective actions', NOW()),
  (1010, 'Access AI Smoke CCTV', 'PAGE_ACCESS_SMOKE', 'Access AI smoke/CCTV monitoring', NOW()),
  (1011, 'Access Environmental Control', 'PAGE_ACCESS_ENVIRONMENT', 'Access environmental monitoring and thresholds', NOW()),
  (1012, 'Access Production & Dispatch', 'PAGE_ACCESS_PRODUCTION', 'Access production and dispatch reporting', NOW()),
  (1013, 'Access AI Facial Attendance', 'PAGE_ACCESS_ATTENDANCE', 'Access workforce attendance and biometric records', NOW()),
  (1014, 'Access Labor & Safety', 'PAGE_ACCESS_LABOR', 'Access labor deployment and workforce records', NOW()),
  (1015, 'Access Contractor Workforce', 'PAGE_ACCESS_CONTRACTORS', 'Access contractor and contractor workforce management', NOW()),
  (1016, 'Access Worker Grievances', 'PAGE_ACCESS_GRIEVANCES', 'Access worker grievance and redressal workflow', NOW()),
  (1017, 'Access Emergency Console', 'PAGE_ACCESS_EMERGENCY', 'Access mine emergency response console', NOW()),
  (1018, 'Access Resource Allocation', 'PAGE_ACCESS_MATERIALS', 'Access material inward and resource allocation', NOW()),
  (1019, 'Access Emergency Alerts', 'PAGE_ACCESS_ALERTS', 'Access role-scoped alerts and notifications', NOW()),
  (1020, 'Access Field Mobile App', 'PAGE_ACCESS_MOBILE_APP', 'Access field mobile application/simulator', NOW()),
  (1021, 'Access Organizations & Mines', 'PAGE_ACCESS_ORGS', 'Access organization and mine administration', NOW()),
  (1022, 'Access User Directory', 'PAGE_ACCESS_USERS', 'Access user directory and assignments', NOW()),
  (1023, 'Access Roles & Subroles', 'PAGE_ACCESS_RBAC', 'Access RBAC administration', NOW()),
  (1024, 'Access Pages & Hierarchy', 'PAGE_ACCESS_PAGES', 'Access page and navigation administration', NOW()),
  (1025, 'Access Audit Log', 'PAGE_ACCESS_AUDIT', 'Access audit history and security events', NOW())
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `description` = VALUES(`description`);

-- -----------------------------------------------------------------------------
-- 6. Role Permissions (Core RBAC Grants + Page Visibility)
-- -----------------------------------------------------------------------------
INSERT INTO `role_permissions` (`role_id`, `permission_id`, `created_at`) VALUES
  -- SUPERADMIN: wildcard gives every platform capability and every page.
  (1, 1, NOW()),

  -- ORG_ADMIN: ECL corporate oversight + organization-scoped administration.
  (2, 2, NOW()), (2, 6, NOW()), (2, 10, NOW()), (2, 12, NOW()), (2, 14, NOW()), (2, 15, NOW()), (2, 20, NOW()), (2, 27, NOW()), (2, 31, NOW()),
  (2, 1003, NOW()), (2, 1005, NOW()), (2, 1006, NOW()), (2, 1007, NOW()), (2, 1008, NOW()), (2, 1009, NOW()), (2, 1011, NOW()), (2, 1012, NOW()), (2, 1014, NOW()), (2, 1015, NOW()), (2, 1016, NOW()), (2, 1017, NOW()), (2, 1019, NOW()), (2, 1021, NOW()), (2, 1022, NOW()), (2, 1025, NOW()),

  -- MINE_ADMIN: full operational management for the assigned mine.
  (3, 6, NOW()), (3, 8, NOW()), (3, 10, NOW()), (3, 11, NOW()), (3, 12, NOW()), (3, 14, NOW()), (3, 27, NOW()), (3, 31, NOW()), (3, 30002, NOW()), (3, 30003, NOW()), (3, 30004, NOW()), (3, 30006, NOW()),
  (3, 1002, NOW()), (3, 1005, NOW()), (3, 1006, NOW()), (3, 1007, NOW()), (3, 1008, NOW()), (3, 1009, NOW()), (3, 1011, NOW()), (3, 1012, NOW()), (3, 1013, NOW()), (3, 1014, NOW()), (3, 1015, NOW()), (3, 1016, NOW()), (3, 1017, NOW()), (3, 1018, NOW()), (3, 1019, NOW()), (3, 1022, NOW()), (3, 1025, NOW()),

  -- SAFETY_OFFICER: safety, compliance, inspections, incidents, environment,
  -- emergency and AI/CCTV intelligence. No HR/store/production administration.
  (4, 6, NOW()), (4, 10, NOW()), (4, 27, NOW()), (4, 31, NOW()),
  (4, 1002, NOW()), (4, 1005, NOW()), (4, 1006, NOW()), (4, 1007, NOW()), (4, 1008, NOW()), (4, 1009, NOW()), (4, 1010, NOW()), (4, 1011, NOW()), (4, 1017, NOW()), (4, 1019, NOW()), (4, 1025, NOW()),

  -- LABOR_OFFICER: workforce, attendance, contractors, grievances and alerts.
  (5, 6, NOW()), (5, 10, NOW()), (5, 11, NOW()), (5, 12, NOW()), (5, 27, NOW()),
  (5, 1002, NOW()), (5, 1013, NOW()), (5, 1014, NOW()), (5, 1015, NOW()), (5, 1016, NOW()), (5, 1017, NOW()), (5, 1019, NOW()),

  -- STORE_OFFICER: materials/resource operations only.
  (6, 6, NOW()), (6, 27, NOW()), (6, 30002, NOW()), (6, 30003, NOW()), (6, 30004, NOW()), (6, 30006, NOW()),
  (6, 1002, NOW()), (6, 1018, NOW()), (6, 1019, NOW()),

  -- SUPERVISOR: shift production + operational incident reporting.
  (7, 6, NOW()), (7, 10, NOW()), (7, 27, NOW()),
  (7, 1002, NOW()), (7, 1009, NOW()), (7, 1012, NOW()), (7, 1017, NOW()), (7, 1019, NOW()),

  -- WORKER: field/mobile workflow and worker-facing emergency/grievance access.
  (8, 6, NOW()), (8, 27, NOW()),
  (8, 1002, NOW()), (8, 1016, NOW()), (8, 1017, NOW()), (8, 1019, NOW()), (8, 1020, NOW()),

  -- REGULATORY_OFFICER: read/oversight across regulated domains, not platform
  -- administration or operational material handling.
  (9, 2, NOW()), (9, 6, NOW()), (9, 10, NOW()), (9, 27, NOW()), (9, 31, NOW()),
  (9, 1004, NOW()), (9, 1005, NOW()), (9, 1006, NOW()), (9, 1007, NOW()), (9, 1008, NOW()), (9, 1009, NOW()), (9, 1011, NOW()), (9, 1012, NOW()), (9, 1013, NOW()), (9, 1014, NOW()), (9, 1015, NOW()), (9, 1016, NOW()), (9, 1017, NOW()), (9, 1019, NOW()), (9, 1025, NOW())
ON DUPLICATE KEY UPDATE `permission_id` = VALUES(`permission_id`);

-- -----------------------------------------------------------------------------
-- 7. Subrole Permissions (Fine-Grained Delegation)
-- -----------------------------------------------------------------------------
-- Subroles intentionally mirror the page visibility of their parent role.
-- Operational capability permissions can be added here later without changing
-- navigation rules.
INSERT INTO `subrole_permissions` (`subrole_id`, `permission_id`, `created_at`) VALUES
  -- Chief Governance Director / SUPERADMIN
  (1, 1, NOW()),

  -- Subsidiary Director (Technical) / ORG_ADMIN
  (2, 2, NOW()), (2, 6, NOW()), (2, 10, NOW()), (2, 12, NOW()), (2, 14, NOW()), (2, 15, NOW()), (2, 20, NOW()), (2, 27, NOW()), (2, 31, NOW()),
  (2, 1003, NOW()), (2, 1005, NOW()), (2, 1006, NOW()), (2, 1007, NOW()), (2, 1008, NOW()), (2, 1009, NOW()), (2, 1011, NOW()), (2, 1012, NOW()), (2, 1014, NOW()), (2, 1015, NOW()), (2, 1016, NOW()), (2, 1017, NOW()), (2, 1019, NOW()), (2, 1021, NOW()), (2, 1022, NOW()), (2, 1025, NOW()),

  -- Colliery Agent & Manager / MINE_ADMIN
  (3, 6, NOW()), (3, 10, NOW()), (3, 14, NOW()), (3, 31, NOW()),
  (3, 1002, NOW()), (3, 1005, NOW()), (3, 1006, NOW()), (3, 1007, NOW()), (3, 1008, NOW()), (3, 1009, NOW()), (3, 1011, NOW()), (3, 1012, NOW()), (3, 1013, NOW()), (3, 1014, NOW()), (3, 1015, NOW()), (3, 1016, NOW()), (3, 1017, NOW()), (3, 1018, NOW()), (3, 1019, NOW()), (3, 1022, NOW()), (3, 1025, NOW()),

  -- Statutory Safety Inspector / SAFETY_OFFICER
  (4, 6, NOW()), (4, 31, NOW()),
  (4, 1002, NOW()), (4, 1005, NOW()), (4, 1006, NOW()), (4, 1007, NOW()), (4, 1008, NOW()), (4, 1009, NOW()), (4, 1010, NOW()), (4, 1011, NOW()), (4, 1017, NOW()), (4, 1019, NOW()), (4, 1025, NOW()),

  -- Chief Welfare Officer / LABOR_OFFICER
  (5, 6, NOW()), (5, 10, NOW()),
  (5, 1002, NOW()), (5, 1013, NOW()), (5, 1014, NOW()), (5, 1015, NOW()), (5, 1016, NOW()), (5, 1017, NOW()), (5, 1019, NOW()),

  -- Chief Store Keeper / STORE_OFFICER
  ...
  -- Continuous Miner Operator / WORKER
  (8, 6, NOW()),
  (8, 1002, NOW()), (8, 1016, NOW()), (8, 1017, NOW()), (8, 1019, NOW()), (8, 1020, NOW()),

  -- DGMS Zonal Auditor / REGULATORY_OFFICER
...
-- -----------------------------------------------------------------------------
-- Navigation is a product concept; permissions below decide which role sees
-- each page. Operational pages are intentionally not exposed to every user.
INSERT INTO `pages` (`id`, `name`, `code`, `route`, `parent_id`, `icon`, `sort_order`, `type`, `status`, `created_at`) VALUES
  ...
  (18, 'Resource Allocation', 'PAGE_MATERIALS', '/resources', NULL, 'Tractor', 18, 'PAGE', 'ACTIVE', NOW()),
  (19, 'Emergency Alerts', 'PAGE_ALERTS', '/alerts', NULL, 'ShieldAlert', 19, 'PAGE', 'ACTIVE', NOW()),
  (20, 'Field Mobile App', 'PAGE_MOBILE_APP', '/mobile-app', NULL, 'Smartphone', 20, 'PAGE', 'ACTIVE', NOW()),
...
-- -----------------------------------------------------------------------------
-- 9. Page Permissions (One Explicit Capability Per Page)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 9A. Intended Navigation Visibility Matrix
-- -----------------------------------------------------------------------------
-- SUPERADMIN       : 1-25 (all pages)
-- ORG_ADMIN        : 3,5,6,7,8,9,11,12,14,15,16,17,19,21,22,25
-- MINE_ADMIN       : 2,5,6,7,8,9,11,12,13,14,15,16,17,18,19,22,25
-- SAFETY_OFFICER   : 2,5,6,7,8,9,10,11,17,19,25
-- LABOR_OFFICER    : 2,13,14,15,16,17,19
-- STORE_OFFICER    : 2,18,19
-- SUPERVISOR       : 2,9,12,17,19
-- WORKER           : 2,16,17,19,20
-- REGULATORY       : 4,5,6,7,8,9,11,12,13,14,15,16,17,19,25
--
-- Note:
-- * Page 1 is platform administration and is intentionally SuperAdmin-only.
-- * Operational roles receive the dashboard relevant to their scope.
-- * Regulatory users receive oversight pages, not platform administration.
-- * Mobile App Simulator is exposed to WORKER only as a prototype/demo route.
-- * Backend authorization must enforce the same permissions; hiding a menu is
